"use strict";
(self["webpackChunksvelte_app"] = self["webpackChunksvelte_app"] || []).push([["vendors-node_modules_astrouxds_astro-web-components_dist_esm_rux-clock_entry_js"],{
...
const ruxClockCss = ":host{display:flex;margin:0 1rem;color:var(--clockTextColor);font-size:1.15rem;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.rux-clock__segment{display:flex;flex-direction:column;align-items:center}.rux-clock__segment__value{display:flex;align-items:center;font-family:var(--fontFamilyMono);font-weight:700;border:1px solid var(--clockBorderColor);background-color:var(--clockBackgroundColor);margin-bottom:0.25rem;white-space:nowrap;overflow-y:hidden;text-overflow:ellipsis}.rux-clock__segment__value{font-size:1.75rem;height:2.75rem;padding:0 0.75rem}:host([small]) .rux-clock__segment__value{height:2.75rem;padding:0 0.75rem;font-size:1.15rem;font-weight:500}.rux-clock__segment__label{font-size:0.875rem;color:var(--clockLabelColor)}.rux-clock__day-of-the-year .rux-clock__segment__value{border-right:none}.rux-clock__segment--secondary .rux-clock__segment__value{font-weight:400}.rux-clock__aos{margin-left:1em}.rux-clock__los{margin-left:0.5em}";
...
const RuxClock = class {
  ...
  _updateTime() {
    ...
    this.dayOfYear = getDayOfYear(zonedTimeToUtc(new Date(Date.now()), this._timezone));
  }
  ...
  render() {
    return ((0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.H, null, !this.hideDate ? ((0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment rux-clock__day-of-the-year" }, (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__day-of-year-label" }, this.dayOfYear), (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__label", id: "rux-clock__day-of-year-label" }, "Date"))) : (''), (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment rux-clock__time" }, (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label" }, this.time), (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label" }, "Time")), this.aos ? ((0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment rux-clock__segment--secondary rux-clock__aos" }, (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--aos", id: "rux-clock__time--aos" }, format(utcToZonedTime(this.aos, this._timezone), 'HH:mm:ss')), (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--aos" }, "AOS"))) : (''), this.los ? ((0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment rux-clock__segment--secondary rux-clock__los" }, (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__value", "aria-labelledby": "rux-clock__time-label--los", id: "rux-clock__time--los" }, format(utcToZonedTime(this.los, this._timezone), 'HH:mm:ss')), (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rux-clock__segment__label", id: "rux-clock__time-label--los" }, "LOS"))) : ('')));
  }
...
//# sourceMappingURL=vendors-node_modules_astrouxds_astro-web-components_dist_esm_rux-clock_entry_js.vendors-node_modules_astrouxds_astro-web-components_dist_esm_rux-clock_entry_js.js.map