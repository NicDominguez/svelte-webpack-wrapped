"use strict";
(self["webpackChunksvelte_app"] = self["webpackChunksvelte_app"] || []).push([["node_modules_astrouxds_astro-web-components_dist_esm_rux-progress_entry_js"],{
...
const RuxProgress = class {
  ...
  checkValueNotOverMax(max, value) {
    if (max && max < value) {
      max = value;
      this.max = max;
  ...
  render() {
    return ((0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.value != undefined ? ([
      (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("progress", { class: "rux-progress", value: this.value, max: this.max }),
      (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("output", { class: "rux-progress__value", hidden: this.hideLabel }, this.getProgressAsString()),
    ]) : ((0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("progress", { class: "rux-progress" })), (0,_index_cf8aeed9_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
...
//# sourceMappingURL=node_modules_astrouxds_astro-web-components_dist_esm_rux-progress_entry_js.node_modules_astrouxds_astro-web-components_dist_esm_rux-progress_entry_js.js.map